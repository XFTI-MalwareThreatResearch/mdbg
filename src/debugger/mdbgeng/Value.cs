...
namespace Microsoft.Samples.Debugging.MdbgEngine
{
    ...
    public sealed class MDbgValue : MarshalByRefObject
    {
        ...
        public object GetObjectValue(bool expand)
        {
            return GetObjectValue(expand ? 1 : 0);
        }
        ...
        public object GetObjectValue(int expandDepth)
        {
            // by default we can do funcevals.
            return GetObjectValue(expandDepth, true);
        }
        ...
        public object GetObjectValue(int expandDepth, bool canDoFunceval)
        {
            return InternalGetValueObject(0, expandDepth, canDoFunceval);
        }
        ...
        private object InternalGetValueObject(int indentLevel, int expandDepth, bool canDoFunceval)
        {
            Debug.Assert(expandDepth >= 0);
